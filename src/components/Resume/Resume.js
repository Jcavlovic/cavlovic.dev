        ...
        <div>
          ...
          <div className='section'>
            ...
            <ul>
              ...
              <li>
                ...
                (November 2024)
                <br />
                Working on porting and deploying Engineering Capstone Project to
                AWS EC2 instance.
                <br />
                Leverage AWS GPU instances to handle object detection inference.
                <br />
                Allow users to choose any video from YouTube to run inference
                using a custom model developed during the Capstone Project.
              </li>
            </ul>
          </div>
          ...
          <div className='section'>
            ...
            <ul>
              ...
              <li>
                ...
                <br />
                Designed a tilt table with automatic adjustment using servos and
                a touchpad.
                <br />
          ...
          <div className='section'>
            ...
            <ul>
              ...
              <li>
                Professors Recommendation for Graduate School | Wei-Ming Lin,
                Ph.D. (May 2024)
              </li>
              <li>
                Spring 2024 UTSA Student Honor Roll | 18 Credit Hours Semester
                (July 2024)
              </li>
            </ul>
          </div>
          ...
          <div className='section'>
            ...
            <ul>
              <li>
                <strong>Bartender</strong> | Red Robin | San Antonio, TX (June
                2015 – July 2024)
                <br />
              ...
              <li>
                <strong>Photographer</strong> | Lujack’s Auto Plaza | Davenport,
                IA (January 2013 - May 2015)
                <br />
